const quizData = [
  {
   question: "عزيزي الطالب انت مهندس الكتروني طلب منك احد العملاء انشاء باب الكتروني فماذا تفعل ؟ ",
    options: ["يتم اختيار دائرة التكيف أولا","يتم اختيار المستشعر أولا"],
    answer: "يتم اختيار المستشعر أولا",
    feedback: "."
  },
  {
    question: "'بعد ان تم اختيار المستشعر ماذا عليك ان تحدد؟ ",
    options: ["دائرة  التكيف","نظام المعالجة"],
    answer: "دائرة  التكيف",
    feedback: "."
  },
  {
    question: "نوع المستشعر الذي تقوم بشرائه هو؟ ",
    options: ["مستشعر الدخان","مستشعر الحركة","مستشعر اللمس"],
    answer: "مستشعر الحركة",
    feedback: "."
  },
  {
    question: "ما الذي تقوم بشرائه لتحليل البيانات واتخاذ القرار الازم ؟",
    options: ["برنامج التحكم","دائرة التكيف والتعزيز"],
    answer: "برنامج التحكم",
    feedback: "."
  },
  {
    question: "طلب منك العميل معرفة التقنية التي تعمل بها ؟",
    options: ["الذكاء الاصطناعي","أجهزة الاستشعار","انترنت الاشياء"],
    answer: "أجهزة الاستشعار",
    feedback: "."
  }
];
